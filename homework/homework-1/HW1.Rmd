...
```{r plotting-comparisons, fig.width=6, fig.height=6, fig.align="center", out.width = "60%"}
...
```{r payroll-vs-winrate, fig.width=5, fig.height=5, fig.align="center", out.width = "30%"}
