...
**The data has 30 rwos  for 54 columns, which does match up with the data description.**
...
mlb_aggregate <- mlb_raw %>% # Creating the mlb_aggregate
  select("Team.name.2014", "payroll", "avgwin") %>% #Selecting the columns for mlb_aggregate
  rename("team" = "Team.name.2014", "payroll_aggregate" = "payroll", #Renaming the columns
         "pct_wins_aggregate" = "avgwin")
mlb_yearly <- mlb_raw %>% # Creating the mlb_yearly
...
mlb_aggregate %>% 
  ...
  kable(format = "latex", row.names = NA,
        ...
        caption = "Aggregate team data over all 17 years") %>% 
...
**mlb-aggregate contains 30 rows, because it is aggregating for each team over the entire seventeen** 
...
```{r plotting-comparisons fig.width=2, fig.height=2, fig.align="center", out.width = "30%"}
...
```{r team-payrolls fig.width=9, fig.height=9, fig.align="center", out.width = "80%"}
...
mlb_yearly %>% 
  ...
  rename(Team = team, "Percentage Increase in Payroll" = payroll_increase) %>% 
...
```{r team-pct-wins fig.width=9, fig.height=9, fig.align="center", out.width = "80%"}
...
```{r payroll-vs-winrate fig.width=3, fig.height=3, fig.align="center", out.width = "30%"}
